...
export const AGENT_RENDERER_REQUEST_KINDS = ["diagnostics.status","agent.provider.test","agent.provider.configure","agent.start","agent.restore","agent.event","agent.research.workflow","agent.task.snapshot"] as const;
