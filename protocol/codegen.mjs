...
// v7 generates the two production contracts only.
//
// MoonBit outputs (`app-moon/protocol/generated.mbt`,
// `desktop-moon/backend/host/request_kinds.g.mbt`) are gone with the retired
// architecture: generating code for a tree that no longer exists would fail, and
// generating it into a tree nobody builds is maintenance with no consumer. The v6
// generated sources remain recoverable from the immutable v6.0.0 tag.
const outputs = [
