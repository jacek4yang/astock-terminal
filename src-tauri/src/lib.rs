...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::news::query_news_center,
            commands::news::refresh_news_center,
            commands::news::set_news_item_state,
            ...
            commands::disclosure::disclosure_sync_start,
            commands::disclosure::disclosure_sync_status,
            commands::disclosure::disclosure_sync_cancel,
            commands::disclosure::query_disclosures,
            commands::disclosure::get_disclosure_detail,
            commands::disclosure::get_disclosure_provider_health,
            commands::global::global_sync_start,
            commands::global::global_sync_status,
            commands::global::global_sync_cancel,
            commands::global::get_global_provider_health,
            commands::global::query_global_documents,
            commands::global::get_global_golden_chains,
            commands::global::get_global_transmission_paths,
            commands::event::event_analysis_start,
            commands::event::event_analysis_status,
            commands::event::event_analysis_cancel,
            commands::relations::relation_extraction_start,
            commands::relations::relation_extraction_status,
            commands::relations::relation_extraction_cancel,
            commands::relations::query_relation_reviews,
            commands::relations::review_relation_candidate,
            commands::relations::retract_relation_candidate,
            ...
            commands::deep::quant_research_start,
            commands::deep::quant_research_status,
            commands::deep::quant_research_cancel,
            commands::deep::quant_research_snapshot_get,
            commands::deep::quant_research_snapshot_list,
