...
- Do not write a figure into a claim statement unless that claim also declares it as a numeric_item. State the meaning in prose and let the declared numbers carry the figures.
